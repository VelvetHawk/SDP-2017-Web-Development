...
if(isset($_POST['loginButton'], $_POST['token'])) {
    ...
    /*
     * FOR HOME USE
     * 6LdEER4UAAAAAHSWGIcTAH8Vw91YGaAVhvxt5jso
    */
    $url = 'https://www.google.com/recaptcha/api/siteverify';
    $privateKey = '6LdEER4UAAAAAHSWGIcTAH8Vw91YGaAVhvxt5jso';
                    ...
                    if ($row = $statement->fetch()) {
                        ...
                        if($activated == "0") {
                            ...
                            if (password_verify($password, $hashed_password)) {
                                ...
                                echo "<script type=\"text/javascript\"> setTimeout(function(){ window.location.href = 'home.php'; }, 3000); </script>";
